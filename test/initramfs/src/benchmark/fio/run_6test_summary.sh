...
# Usage: [KEEP_LOGS=1] ./run_6test_summary.sh
...
RESULT_FILES=(
    "${ASTER_DIR}/result_fio-raw_seq_read_bw.json"
    "${ASTER_DIR}/result_fio-raw_seq_write_bw.json"
    "${ASTER_DIR}/result_fio-ext4_seq_read_bw.json"
    "${ASTER_DIR}/result_fio-ext4_seq_write_bw.json"
    "${ASTER_DIR}/result_fio-ext4_nojournal_seq_read_bw.json"
    "${ASTER_DIR}/result_fio-ext4_nojournal_seq_write_bw.json"
)
