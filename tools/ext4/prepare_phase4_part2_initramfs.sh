...
OUT_IMG=${2:-"${ROOT_DIR}/benchmark/assets/initramfs/initramfs_phase4_part2.cpio.gz"}
...
echo "[INFO] Patching xfstests scripts for phase4_part2 ..."
...
echo "[DONE] Prepared phase4_part2 initramfs: ${OUT_IMG}"
