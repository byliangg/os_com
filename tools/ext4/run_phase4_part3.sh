...
CRASH_SCENARIOS=${CRASH_SCENARIOS:-"create_write:write rename:rename truncate_append:write large_write:rename fsync_durability:rename multi_file_create:rename dir_tree_churn:rmdir truncate_shrink:truncate dir_delete_reuse:write append_concurrent:rename"}
