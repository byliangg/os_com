...
DOCKER_ENV_ARGS=(
  ...
  -e CRASH_SCENARIOS="${CRASH_SCENARIOS}"
  -e CRASH_EXPECT="${CRASH_EXPECT}"
  -e EXT4_PHASE2_CASES="${EXT4_PHASE2_CASES}"
  -e EXT4_PHASE2_WORKERS="${EXT4_PHASE2_WORKERS}"
  -e EXT4_PHASE2_ROUNDS="${EXT4_PHASE2_ROUNDS}"
  ...
  -e EXT4_PAGE_CACHE_OVERRIDE="${EXT4_PAGE_CACHE_OVERRIDE:-}"
  -e EXT4_PAGE_CACHE_IO_OVERRIDE="${EXT4_PAGE_CACHE_IO_OVERRIDE:-}"
  -e EXT4_SMALL_WRITE_PREALLOC_OVERRIDE="${EXT4_SMALL_WRITE_PREALLOC_OVERRIDE:-}"
  -e EXT4_PAGE_CACHE_EVICT_ON_CLOSE_OVERRIDE="${EXT4_PAGE_CACHE_EVICT_ON_CLOSE_OVERRIDE:-}"
)
...
run_part3_with_flags() {
  env \
    ...
    EXT4_PAGE_CACHE_OVERRIDE="${EXT4_PAGE_CACHE_OVERRIDE:-}" \
    EXT4_PAGE_CACHE_IO_OVERRIDE="${EXT4_PAGE_CACHE_IO_OVERRIDE:-}" \
    EXT4_SMALL_WRITE_PREALLOC_OVERRIDE="${EXT4_SMALL_WRITE_PREALLOC_OVERRIDE:-}" \
    EXT4_PAGE_CACHE_EVICT_ON_CLOSE_OVERRIDE="${EXT4_PAGE_CACHE_EVICT_ON_CLOSE_OVERRIDE:-}" \
